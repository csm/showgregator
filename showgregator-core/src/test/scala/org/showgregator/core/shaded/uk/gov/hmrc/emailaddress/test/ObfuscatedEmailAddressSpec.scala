...
import org.showgregator.core.shaded.uk.gov.hmrc.emailaddress.ObfuscatedEmailAddress

class ObfuscatedEmailAddressSpec extends WordSpec with Matchers with PropertyChecks with EmailAddressGenerators {
